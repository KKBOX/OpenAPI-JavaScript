...
### npm install
```
npm install @kkbox/kkbox-javascript-developer-sdk
```
...
```
import {Auth} from '@kkbox/kkbox-javascript-developer-sdk'
...
```
import {Api} from '@kkbox/kkbox-javascript-developer-sdk'
